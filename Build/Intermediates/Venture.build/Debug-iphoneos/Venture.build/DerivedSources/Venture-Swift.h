...
SWIFT_CLASS("_TtC7Venture11AppDelegate")
...
SWIFT_CLASS("_TtC7Venture28ItineraryTableViewController")
@interface ItineraryTableViewController : UITableViewController
@property (nonatomic) NSInteger index;
@property (nonatomic, readonly, copy) NSString * _Nonnull planCellID;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7Venture28LocationsTableViewController")
@interface LocationsTableViewController : UITableViewController
@property (nonatomic, readonly, copy) NSString * _Nonnull placeCellID;
@property (nonatomic, readonly, copy) NSString * _Nonnull SETTINGS_ID;
@property (nonatomic) NSInteger index;
- (void)viewDidLoad;
- (void)refresh:(id _Nonnull)sender;
- (void)didReceiveMemoryWarning;
...
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (BOOL)tableView:(UITableView * _Nonnull)tableView canEditRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (IBAction)settingsPressed:(id _Nonnull)sender;
- (nonnull instancetype)initWithStyle:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@class GMSMapView;
@class GMSPlacePicker;
@class GMSPlacesClient;
@class CLLocationManager;
@class CLLocation;
@class GMSMarker;

SWIFT_CLASS("_TtC7Venture17MapViewController")
@interface MapViewController : UIViewController <CLLocationManagerDelegate, GMSMapViewDelegate>
@property (nonatomic, strong) GMSMapView * _Null_unspecified mapView;
@property (nonatomic, strong) GMSPlacePicker * _Null_unspecified placePicker;
@property (nonatomic, strong) GMSPlacesClient * _Nullable placesClient;
@property (nonatomic, strong) CLLocationManager * _Null_unspecified locationManager;
@property (nonatomic, strong) CLLocation * _Null_unspecified myLocation;
@property (nonatomic) NSInteger index;
@property (nonatomic, readonly, copy) NSString * _Nonnull SETTINGS_ID;
- (void)viewDidLoad;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (IBAction)venturePressed:(id _Nonnull)sender;
- (void)loadView;
...
SWIFT_CLASS("_TtC7Venture11PlaceMarker")
...
SWIFT_CLASS("_TtC7Venture22SettingsViewController")
...
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)radiusChanged:(id _Nonnull)sender;
- (void)setRadiusLabelValue:(NSInteger)radius;
...
SWIFT_CLASS("_TtC7Venture24SwitchPageViewController")
@interface SwitchPageViewController : UIPageViewController <UIPageViewControllerDataSource>
@property (nonatomic, readonly, copy) NSString * _Nonnull MAP_ID;
@property (nonatomic, readonly, copy) NSString * _Nonnull LIST_ID;
@property (nonatomic, readonly, copy) NSString * _Nonnull PLAN_ID;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
